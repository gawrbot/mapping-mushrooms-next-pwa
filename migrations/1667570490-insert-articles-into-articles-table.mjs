const articles = [
  ...
  {
    title: '☠️ Death Cap (Amanita phalloides)',
    slug: 'death-cap',
    image_preview:
  ...
  {
    title: '☠️ False Parasol (Chlorophyllum molybdites)',
    slug: 'false-parasol',
    image_preview:
  ...
  {
    title: '☠️ Brown Roll-Rim (Paxillus involuts)',
    slug: 'brown-roll',
    image_preview:
  ...
  {
    title: '☠️ Deadly Conocybe (Conocybe filaris)',
  ...
  {
    title: '☠️ Elfin Saddle (Gyromitra infula)',
    slug: 'elfin-saddle',
    image_preview:
  ...
  {
    title: '☠️ Destroying Angel (Amanita bisporigera)',
  ...
  {
    title: '☠️ Scaly Vase Chanterelle (Turbinellus floccosus)',
  ...
  {
    title: '☠️ Yellow Stainer (Agaricus xanthodermus)',
    slug: 'yellow-stainer',
    image_preview:
  ...
  {
    title: '☠️ Satan’s Bolete (Rubroboletus satanas)',
    slug: 'satans-bolete',
    image_preview:
  ...
  {
    title: '☠️ Jack O’Lantern (Omphalotus illudens)',
    slug: 'jack-olantern',
    image_preview:
  ...
  {
    title: '☠️ Ivory Funnel (Clitocybe dealbata)',
    slug: 'ivory-funnel',
    image_preview:
  ...
  {
    title: '☠️ Autumn Skullcap (Galerina marginata)',
  ...
  {
    title: '☠️ Inky Cap (Coprinopsis atramentaria)',
    slug: 'inky-cap',
    image_preview:
  ...
  {
    title: '☠️ False Champignon (Clitocybe rivulosa)',
  ...
  {
    title: '☠️ Deadly Webcap (Cortinarius rubellus)',
    slug: 'deadly-webcap',
    image_preview:
  ...
  {
    title: '☠️ Brain Mushroom (Gyromitra esculenta)',
    slug: 'brain-mushroom',
    image_preview:
  ...
  {
    title: '☠️ Lilac Bonnet (Mycena pura)',
    slug: 'lilac-bonnet',
    image_preview:
  ...
  {
    title: '☠️ Angel Wing (Pleurocybella porrigens)',
    slug: 'angel-wing',
    image_preview:
  ...
  {
    title: '☠️ Sulfur Tuft (Hypholoma fasciculare)',
    slug: 'sulfur-tuft',
    image_preview:
  ...
  {
    title: '☠️ Emetic Russula (Russula fragrantissima)',
    slug: 'emetic-russula',
    image_preview:
